            ...
            <div class="row">
                  ...
                  <div class="col-10">
                    ...
                    <div class="card">
                      ...
                      <div data-flickity='{"draggable": false, "fade": true}' id="productSlider">
                        ...
                        <!-- Item -->
                        <a href="#" data-bigpicture='{ "imgSrc": "assets/img/products/product-112.jpg"}'>
                          <img src="assets/img/products/product-112.jpg" alt="..." class="card-img-top">
                        </a>

                        <!-- Item -->
                        <a href="#" data-bigpicture='{ "imgSrc": "assets/img/products/product-113.jpg"}'>
                          <img src="assets/img/products/product-113.jpg" alt="..." class="card-img-top">
                        </a>

                        <!-- Item -->
                        <a href="#" data-bigpicture='{ "imgSrc": "assets/img/products/product-114.jpg"}'>
                          <img src="assets/img/products/product-114.jpg" alt="..." class="card-img-top">
                        </a>

                        <!-- Item -->
                        <a href="#" data-bigpicture='{ "imgSrc": "assets/img/products/product-115.jpg"}'>
              ...
              <div class="col-12 col-md-6 ps-lg-10">
                ...
                <div class="mb-7 text-gray-400">
                  <span class="ms-1 fs-5 fw-bold">$30.00</span>
                  <span class="ms-1 fs-sm">(Out of Stock)</span>
                </div>
