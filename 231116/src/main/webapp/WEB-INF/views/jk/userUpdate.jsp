                    ...
                    <div class="col-12 col-md-8">
                      <div class="form-group">
                     	<div class="form-floating mb-3">
	                        <input class="form-control form-control-sm" type="text" id="user_id" name="user_id" value="${user1.user_id}" onchange="checkId()" readonly>
...
<!--                     </div> -->
                    ...
                    <div class="col-12 col-md-8">
                      <div class="form-group">
                      	<div class="form-floating mb-3">
                        	<input class="form-control form-control-sm" type="text" id="nick" name="nick" value="${user1.user_name}"  onchange="checkNick()">
